"""Photos test constants.

This module contains comprehensive test fixtures for the Photos service including:
- Album query responses (CPLAlbumByPositionLive)
- Photo asset records (CPLAsset/CPLMaster pairs)
- Multiple album types (All Photos, Favorites, Videos, etc.)
- Subalbum structures
- Photo version data (original, medium, thumb)
- Indexing state responses

Ported from icloud-docker project's photos_data.py.
"""
        ...
        },
        {
            ...
            "response": {
                "records": [
                    ...
                    # GoPro video without filename (test for missing filenameEnc)
                    {
                        "recordName": "GOPRO-NO-FILENAME-TEST-MASTER",
                        "recordType": "CPLMaster",
                        "fields": {
                            "itemType": {"value": "public.mpeg-4", "type": "STRING"},
                            "resVidSmallFingerprint": {
                                "value": "GOPRO-TEST-FINGERPRINT",
                                "type": "STRING",
                            },
                            # NOTE: filenameEnc is intentionally missing to test the fix
                            "resVidSmallRes": {
                                "value": {
                                    "fileChecksum": "GOPRO-TEST-CHECKSUM",
                                    "size": 1024000,
                                    "wrappingKey": "test==",
                                    "referenceChecksum": "GOPRO-TEST-REF",
                                    "downloadURL": "https://cvws.icloud-content.com/test/gopro",
                                },
                                "type": "ASSETID",
                            },
                            "originalOrientation": {"value": 1, "type": "INT64"},
                            "resVidSmallHeight": {"value": 720, "type": "INT64"},
                            "resOriginalRes": {
                                "value": {
                                    "fileChecksum": "GOPRO-ORIGINAL-CHECKSUM",
                                    "size": 10240000,
                                    "wrappingKey": "test2==",
                                    "referenceChecksum": "GOPRO-ORIGINAL-REF",
                                    "downloadURL": "https://cvws.icloud-content.com/test/gopro-original",
                                },
                                "type": "ASSETID",
                            },
                            "resOriginalWidth": {"value": 1920, "type": "INT64"},
                            "resOriginalFingerprint": {
                                "value": "GOPRO-ORIGINAL-FINGERPRINT",
                                "type": "STRING",
                            },
                            "resOriginalFileType": {
                                "value": "public.mpeg-4",
                            ...
                            "resOriginalHeight": {"value": 1080, "type": "INT64"},
                            "resVidSmallFileType": {
                                "value": "public.mpeg-4",
                                "type": "STRING",
                            },
                            "dataClassType": {"value": 3, "type": "INT64"},
                            "resVidSmallWidth": {"value": 1280, "type": "INT64"},
                        },
                        "pluginFields": {},
                        "recordChangeTag": "test1",
                        "created": {
                    ...
                    # Reference to GoPro video
                    {
                        "recordName": "GOPRO-NO-FILENAME-TEST-ASSET",
                        "recordType": "CPLAsset",
                        "fields": {
                            "assetDate": {"value": 1600000000000, "type": "TIMESTAMP"},
                            "orientation": {"value": 1, "type": "INT64"},
                            "addedDate": {"value": 1600000000000, "type": "TIMESTAMP"},
                            "assetSubtypeV2": {"value": 0, "type": "INT64"},
                            "assetHDRType": {"value": 0, "type": "INT64"},
                            "timeZoneOffset": {"value": 0, "type": "INT64"},
                            "masterRef": {
                                "value": {
                                    "recordName": "GOPRO-NO-FILENAME-TEST-MASTER",
                                    "action": "DELETE_SELF",
                            ...
                            "vidComplDispScale": {"value": 0, "type": "INT64"},
                            "isHidden": {"value": 0, "type": "INT64"},
                            "duration": {"value": 30000, "type": "INT64"},
                            "burstFlags": {"value": 0, "type": "INT64"},
                            "assetSubtype": {"value": 0, "type": "INT64"},
                            "vidComplDurScale": {"value": 0, "type": "INT64"},
                            "vidComplDurValue": {"value": 0, "type": "INT64"},
